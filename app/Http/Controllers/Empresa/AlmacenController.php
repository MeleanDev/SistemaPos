...
class AlmacenController extends Controller
{
    ...
    {
        try {
            $almacen = $this->almacenClass->detalle((int) $id, $this->obtenerEmpresaId());
    ...
    {
        try {
            $almacen = $this->almacenClass->guardar($datos->validated(), $this->obtenerEmpresaId());
    ...
    {
        try {
            $almacen = $this->almacenClass->actualizar($datos->validated(), (int) $id, $this->obtenerEmpresaId());
    ...
    {
        try {
            $almacen = $this->almacenClass->eliminar((int) $id, $this->obtenerEmpresaId());
