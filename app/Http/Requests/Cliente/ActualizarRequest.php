...
class ActualizarRequest extends FormRequest
{
    ...
    {
        $clienteId = $this->route('id') ?? $this->id;
        ...
        return [
            'cedula' => [
                ...
                'string',
                'max:20',
                Rule::unique('clientes', 'cedula')->ignore($clienteId)->where(fn ($query) => $query->where('estado', true)),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'cedula.unique' => 'Ya existe otro cliente registrado con esta cédula o RIF.',
